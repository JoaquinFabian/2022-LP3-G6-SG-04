...
public class LabelFrame extends JFrame {
    ...
    private JLabel etiqueta4; // Jbal con texto icono centrado en la parte superior
    ...
    public LabelFrame() {
        ...
        Icon insecto = new ImageIcon(getClass().getResource("Imagenes/insecto1.png"));
        ...
        Icon DOG = new ImageIcon(getClass().getResource("Imagenes/dog.png"));
        etiqueta4 = new JLabel();
        etiqueta4.setText("Etiqueta 4 con icono de perro en la parte sup y imagen abajo");
        etiqueta4.setIcon(DOG);
        etiqueta4.setHorizontalTextPosition(SwingConstants.CENTER);
        etiqueta4.setVerticalTextPosition(SwingConstants.TOP);
        etiqueta4.setToolTipText("Esta es etiqueta4 con perro");
        add(etiqueta4); // agrega etiqueta3 a JFrame
